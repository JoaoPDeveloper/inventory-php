...
class RoleController extends Controller
{
    ...
    public function Permission(Request $request)
    {
        try {
            ...
            return response()->json(['status' => 'success', 'message' => 'Nova Permissão Adicionada']);
        } catch (\Exception $e) {
            \DB::rollBack();

            return response()->json(['status' => 'error', 'message' => 'Algo saiu errado!']);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return response()->json(['status' => 'success', 'message' => 'Função atualizada']);
        } catch (\Exception $e) {
            return response()->json(['status' => 'error', 'message' => 'Algo saiu errado!']);
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json(['status' => 'error', 'Algo saiu errado!']);
        }
    }
